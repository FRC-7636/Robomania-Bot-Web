...
class DiscordBotMemberConsumer(AsyncJsonWebsocketConsumer):
    async def connect(self):
        self.room_name = "member_updates"
        self.room_group_name = "member_updates"
    ...
    async def member_add_warning_points(self, event: dict):
